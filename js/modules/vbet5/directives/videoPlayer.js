    ...
    return {
        ...
        link: function (scope, element, attrs) {
           ...
           // var parent = scope.$parent;
            if (providerId === '21' || providerId === '22' || providerId === '23' || providerId === '24' || providerId === '29') { // for dota and windbet stream we must show streams in iframe
                    ...
                    if ($window.document.getElementById(attrs.playerId)) { //wait until element becomes available
                        swfobject.embedSWF(swfPath, attrs.playerId, "100%", "100%", "11.1", "swf/playerProductInstall.swf", {}, params, attributes, function (obj) {
                            if (obj.success === false) {
                                ...
                                var htmlTemplate = '<div class="flash-download-b"><a href="http://www.adobe.com/go/getflashplayer"><img src="' + iconUrl + '" alt="Get Adobe Flash player"/></a></div>';
