/**
 * @ngdoc controller
 * @name vbet5.controller:euro2016DashboardCenterController
 * @description
...
//         return ['sport', 'liveToday', 'popularEvents'].indexOf(parentMainScope.selectedCentralView) !== -1;
     ...
     * @param {Function} Execution callback
     */
     ...
     * @param {Object} data
     * @param {Number} Sub ID
     * @param {Function} Execution sport callback
     * @param {Function} Execution game callback
     */
