...
/**
 * @ngdoc service
 * @name vbet5.service:keyboardManager
 * @description keyboardManager
 *
 */
VBET5.factory('keyboardManager', ['$window', '$timeout', function ($window, $timeout) {
    'use strict';
    ...
    keyboardManagerService.bind = function (label, callback, opt) {
        ...
        if (typeof opt.target === 'string') {
            elt = $window.document.getElementById(opt.target);
        }
        ...
        fct = function (e) {
            ...
            var i, l, k;
            for (i = 0, l = keys.length; k = keys[i], i < l; i++) {
                switch (k) {
                case 'ctrl':
                case 'control':
                    kp++;
