...
function print() { __p += __j.call(arguments, '') }
  ...
  ((__t = ( obj.step.width )) == null ? '' : __t) +
  'px; padding: ' +
  ((__t = ( obj.step.padding )) == null ? '' : __t) +
  'px;">\n  ';
   if(obj.tour.isTour){ ;
  __p += '<span class="hopscotch-bubble-number">' +
  ((__t = ( obj.i18n.stepNum )) == null ? '' : __t) +
  '</span>';
   } ;
  __p += '\n  <div class="hopscotch-bubble-content">\n    ';
   if(obj.step.title !== ''){ ;
  __p += '<h3 class="hopscotch-title">' +
  ((__t = ( optEscape(obj.step.title, obj.tour.unsafe) )) == null ? '' : __t) +
  '</h3>';
   } ;
  __p += '\n    ';
   if(obj.step.content  !== ''){ ;
  __p += '<div class="hopscotch-content">' +
  ((__t = ( optEscape(obj.step.content, obj.tour.unsafe) )) == null ? '' : __t) +
  '</div>';
   } ;
  __p += '\n  </div>\n  <div class="hopscotch-actions">\n    ';
   if(obj.buttons.showPrev){ ;
  __p += '<button class="hopscotch-nav-button prev hopscotch-prev">' +
  ((__t = ( obj.i18n.prevBtn )) == null ? '' : __t) +
  '</button>';
   } ;
  __p += '\n    ';
   if(obj.buttons.showCTA){ ;
  __p += '<button class="hopscotch-nav-button next hopscotch-cta">' +
  ((__t = ( obj.buttons.ctaLabel )) == null ? '' : __t) +
  '</button>';
   } ;
  __p += '\n    ';
   if(obj.buttons.showNext){ ;
  __p += '<button class="hopscotch-nav-button next hopscotch-next">' +
  ((__t = ( obj.i18n.nextBtn )) == null ? '' : __t) +
  '</button>';
   } ;
  __p += '\n  </div>\n  ';
   if(obj.buttons.showClose){ ;
  __p += '<button class="hopscotch-bubble-close hopscotch-close">' +
  ((__t = ( obj.i18n.closeTooltip )) == null ? '' : __t) +
  '</button>';
   } ;
