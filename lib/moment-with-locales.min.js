!function (a, b) {
    ...
    function La(a, b) {
        var c = (b || '').match(a) || [], d = c[c.length - 1] || [], e = (d + '').match(Re) || ['-', 0, 0],
            f = +(60 * e[1]) + r(e[2]);
        return '+' === e[0] ? f : -f
    }
    ...
    function Qc(a, b, c) {
        var d = Za(a).abs(), e = Gf(d.as('s')), f = Gf(d.as('m')), g = Gf(d.as('h')), h = Gf(d.as('d')),
            i = Gf(d.as('M')), j = Gf(d.as('y')),
...
//! Author : Menelion Elensúle : https://github.com/Oire
    ...
    var Rd, Sd, Td = a.momentProperties = [], Ud = !1, Vd = {}, Wd = {},
        ...
        Yd = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, Zd = {}, $d = {}, _d = /\d/, ae = /\d\d/, be = /\d{3}/,
        ce = /\d{4}/, de = /[+-]?\d{6}/, ee = /\d\d?/, fe = /\d\d\d\d?/, ge = /\d\d\d\d\d\d?/, he = /\d{1,3}/,
        ie = /\d{1,4}/, je = /[+-]?\d{1,6}/, ke = /\d+/, le = /[+-]?\d+/, me = /Z|[+-]\d\d:?\d\d/gi,
        ne = /Z|[+-]\d\d(?::?\d\d)?/gi, oe = /[+-]?\d+(\.\d{1,3})?/,
        pe = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,
        qe = {}, re = {}, se = 0, te = 1, ue = 2, ve = 3, we = 4, xe = 5, ye = 6, ze = 7, Ae = 8;
    ...
    var Be = /D[oD]?(\[[^\[\]]*\]|\s+)+MMMM?/,
        ...
        De = 'Jan_Feb_Mar_Apr_May_Jun_Jul_Aug_Sep_Oct_Nov_Dec'.split('_'), Ee = pe, Fe = pe, Ge = {};
    ...
    var Ze = 'Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday'.split('_'),
        $e = 'Sun_Mon_Tue_Wed_Thu_Fri_Sat'.split('_'), _e = 'Su_Mo_Tu_We_Th_Fr_Sa'.split('_');
    ...
    var qf = Math.abs, rf = Lc('ms'), sf = Lc('s'), tf = Lc('m'), uf = Lc('h'), vf = Lc('d'), wf = Lc('w'),
        xf = Lc('M'), yf = Lc('y'), zf = Nc('milliseconds'), Af = Nc('seconds'), Bf = Nc('minutes'), Cf = Nc('hours'),
        Df = Nc('days'), Ef = Nc('months'), Ff = Nc('years'), Gf = Math.round, Hf = {s: 45, m: 45, h: 22, d: 26, M: 11},
...
//! momentjs.com
    ...
    var Kf = a, Lf = (Kf.defineLocale('af', {
        ...
        Mf = {'١': '1', '٢': '2', '٣': '3', '٤': '4', '٥': '5', '٦': '6', '٧': '7', '٨': '8', '٩': '9', '٠': '0'},
        ...
        Of = {'١': '1', '٢': '2', '٣': '3', '٤': '4', '٥': '5', '٦': '6', '٧': '7', '٨': '8', '٩': '9', '٠': '0'},
        Pf = function (a) {
        ...
        Sf = ['كانون الثاني يناير', 'شباط فبراير', 'آذار مارس', 'نيسان أبريل', 'أيار مايو', 'حزيران يونيو', 'تموز يوليو', 'آب أغسطس', 'أيلول سبتمبر', 'تشرين الأول أكتوبر', 'تشرين الثاني نوفمبر', 'كانون الأول ديسمبر'],
        ...
        Vf = {'১': '1', '২': '2', '৩': '3', '৪': '4', '৫': '5', '৬': '6', '৭': '7', '৮': '8', '৯': '9', '০': '0'},
        ...
        Xf = {'༡': '1', '༢': '2', '༣': '3', '༤': '4', '༥': '5', '༦': '6', '༧': '7', '༨': '8', '༩': '9', '༠': '0'},
        ...
        Zf = 'led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro'.split('_'), $f = (Kf.defineLocale('cs', {
            months: Yf,
            monthsShort: Zf,
        ...
        _f = ['އާދިއްތަ', 'ހޯމަ', 'އަންގާރަ', 'ބުދަ', 'ބުރާސްފަތި', 'ހުކުރު', 'ހޮނިހިރު'], ag = (Kf.defineLocale('dv', {
            months: $f,
            monthsShort: $f,
            weekdays: _f,
            weekdaysShort: _f,
        ...
        bg = 'ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic'.split('_'), cg = (Kf.defineLocale('es', {
        ...
        dg = {'۱': '1', '۲': '2', '۳': '3', '۴': '4', '۵': '5', '۶': '6', '۷': '7', '۸': '8', '۹': '9', '۰': '0'},
        ...
        fg = ['nolla', 'yhden', 'kahden', 'kolmen', 'neljän', 'viiden', 'kuuden', eg[7], eg[8], eg[9]],
        ...
        hg = 'jan_feb_mrt_apr_mai_jun_jul_aug_sep_okt_nov_des'.split('_'), ig = (Kf.defineLocale('fy', {
        ...
        jg = ['Faoi', 'Gear', 'Màrt', 'Gibl', 'Cèit', 'Ògmh', 'Iuch', 'Lùn', 'Sult', 'Dàmh', 'Samh', 'Dùbh'],
        kg = ['Didòmhnaich', 'Diluain', 'Dimàirt', 'Diciadain', 'Diardaoin', 'Dihaoine', 'Disathairne'],
        lg = ['Did', 'Dil', 'Dim', 'Dic', 'Dia', 'Dih', 'Dis'], mg = ['Dò', 'Lu', 'Mà', 'Ci', 'Ar', 'Ha', 'Sa'],
        ...
        og = {'१': '1', '२': '2', '३': '3', '४': '4', '५': '5', '६': '6', '७': '7', '८': '8', '९': '9', '०': '0'},
        pg = (Kf.defineLocale('hi', {
            ...
            months: 'Janoary_Febroary_Martsa_Aprily_May_Jone_Jolay_Aogositra_Septambra_Oktobra_Novambra_Desambra'.split('_'),
            monthsShort: 'Jan_Feb_Mar_Apr_May_Jon_Jol_Aog_Sep_Oct_Nov_Des'.split('_'),
            ...
            calendar: {
                ...
                nextWeek: 'dddd [@] LT',
                lastDay: '[Omaly t@] LT',
                lastWeek: '[Erinandro lasa] dddd [@] LT',
                sameElse: 'L'
            },
            relativeTime: {
                future: 'afaka %s',
        ...
        vg = {'१': '1', '२': '2', '३': '3', '४': '4', '५': '5', '६': '6', '७': '7', '८': '8', '९': '9', '०': '0'},
        ...
        xg = {'၁': '1', '၂': '2', '၃': '3', '၄': '4', '၅': '5', '၆': '6', '၇': '7', '၈': '8', '၉': '9', '၀': '0'},
        ...
        zg = {'१': '1', '२': '2', '३': '3', '४': '4', '५': '5', '६': '6', '७': '7', '८': '8', '९': '9', '०': '0'},
        ...
        Bg = 'jan_feb_mrt_apr_mei_jun_jul_aug_sep_okt_nov_dec'.split('_'), Cg = (Kf.defineLocale('nl', {
        ...
        Gg = 'jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec'.split('_'), Hg = (Kf.defineLocale('sk', {
            months: Fg,
            monthsShort: Gg,
        ...
        Kg = {'௧': '1', '௨': '2', '௩': '3', '௪': '4', '௫': '5', '௬': '6', '௭': '7', '௮': '8', '௯': '9', '௦': '0'},
